...
본 연구는 2022년 열시스템디자인 과제를 재현 가능한 코드 기반 설계 연구로 다시 구성한 결과물이다. 대상 IDC의 총 냉방부하는 **13,476.0 kW**로 계산되었고, 이론 최소동력은 **1,215.8 kW**, 기준 R-134a 증기압축 시스템의 압축기 동력은 **4,185.4 kW**로 산정되었다. 이에 비해 LNG 냉열 기반 시스템은 **R-717 (Ammonia)**를 2차 루프 냉각유체로 사용할 때 LNG 기화 duty **18,010.5 kW**, 배관 열유입 **580.4 kW**, LNG 순환펌프 **22.2 kW**와 IDC 2차 루프 펌프 **123.7 kW**를 포함한 핵심 전동부하 **145.9 kW**의 supplemental warm-up을 포함한 하이브리드 운전 기준 설계가 가능했다. 그 결과 기준 시스템 대비 전력 절감은 **4,039.6 kW**, 연간 전력 절감은 **35,386.6 MWh/년**, 연간 비용 절감은 **3,717.4 백만원/년**, 연간 회피 배출은 **16,224.7 tCO2/년**으로 평가되었다. 대표 혼합 LNG는 **Peak-shaving LNG surrogate**으로 모델링했고, 10 km 기본안 기준 핵심 설비 CAPEX는 **66.32 십억원**, NPV는 **-42.85 십억원**으로 추정되었다. 현재 운전점에서의 추정 최대 하이브리드 운전 가능거리는 약 **103.8 km**, 기본 LNG duty 기준 최대 성립거리는 약 **0.0 km**이며, 35 km 조건은 **하이브리드 운전 가능, 기본 LNG duty 불성립**으로 판정되었다.

*출처 ID: SRC-001,SRC-004,SRC-005,SRC-006,SRC-007,SRC-008,SRC-010,SRC-013,SRC-014,SRC-019,SRC-020,SRC-021,SRC-022,SRC-023,SRC-024,SRC-025,ASM-020,ASM-033,ASM-034,ASM-035,ASM-055,ASM-056,ASM-057,ASM-058,ASM-059,ASM-060,ASM-061,ASM-062,ASM-063,ASM-064,ASM-065,ASM-066,ASM-067,ASM-068,ASM-069*
...
| 유체 | 스크리닝 점수 | Core system power (kW) | 추가 warm-up (kW) | 쉘 직경 (m) | 연간 비용절감 (백만원/년) |
| --- | --- | --- | --- | --- | --- |
| R-717 (Ammonia) | 0.795 | 145.9 | 3,954.0 | 0.792 | 3,717.4 |
| R-290 (Propane) | 0.077 | 344.2 | 4,240.3 | 0.914 | 3,534.8 |
| R-600a (Isobutane) | 0.059 | 358.9 | 4,148.2 | 0.914 | 3,521.3 |

기본 설계점에서 최상위 유체는 **R-717 (Ammonia)**였고, 요구 질량유량은 **54.4 kg/s**였다. 또한 IDC 측 열교환기의 요구 면적은 **567.2 m2**, IDC 출구 냉각유체 온도는 **2.0 °C**, LNG 입구 환수온도는 **19.9 °C**로 계산되었다.
...
| --- | --- | --- | --- | --- | --- |
| 112-190 K | 6,563.2 | 112.0 | 190.0 | 247.2 | 220.0 |
| 190-205 K | 2,197.5 | 190.0 | 205.0 | 256.2 | 247.2 |
| 205-220 K | 3,517.4 | 205.0 | 220.0 | 270.4 | 256.2 |
| 220-283 K | 5,732.3 | 220.0 | 283.0 | 293.0 | 270.4 |
...
| LNG 외부 루프 펌프동력 | 22.2 kW |
| Core system power | 145.9 kW |
| 공급관 속도 | 0.840 m/s |
| 환수관 속도 | 0.906 m/s |
| 공급관 압력강하 | 96.5 kPa |
| 환수관 압력강하 | 101.3 kPa |
...
연간화는 데이터센터의 상시 운전을 반영해 8,760시간/년 기준으로 수행했다. 전력요금과 전력 배출계수는 공식 자료를 기준으로 입력했고, 현재 버전에서는 LNG 외부 루프 펌프와 IDC 2차 루프 펌프를 합한 core LNG system power를 기준 압축기 동력과 비교했다. 또한 설치비, 연간 O&M, 할인율을 포함한 NPV/IRR을 함께 계산했다.
...
CF_{\mathrm{net}} = \Delta C_{\mathrm{year}} - f_{\mathrm{O\&M}} \cdot CAPEX
NPV = -CAPEX + \sum_{t=1}^{N}\frac{CF_{\mathrm{net}}}{(1+r)^t}
IRR:\ 0 = -CAPEX + \sum_{t=1}^{N}\frac{CF_{\mathrm{net}}}{(1+IRR)^t}
```

*출처 ID: SRC-013,SRC-014,SRC-021,SRC-022,SRC-023,SRC-024,SRC-025,ASM-030,ASM-031,ASM-057,ASM-058,ASM-059,ASM-060,ASM-061,ASM-062,ASM-063,ASM-064,ASM-065,ASM-066,ASM-067,ASM-068*
...
| LNG 외부 루프 펌프동력 | 22.2 kW |
| IDC 2차 루프 펌프동력 | 123.7 kW |
| Core system power | 145.9 kW |
| Core installed CAPEX | 66.32 십억원 |
| Core-system NPV | -42.85 십억원 |
| 등가 냉각 COP | 92.4 |
| 기준 대비 절감 동력 | 4,039.6 kW |

가장 먼저 눈에 띄는 결과는 **92.4**에 달하는 등가 냉각 COP다. 이 값은 동일 냉방부하를 처리하기 위해 요구되는 전력의 크기가 얼마나 줄었는지를 보여준다.
...
| 거리 (km) | Core system power (kW) | 열유입 (kW) | 추가 warm-up (kW) | 기본 duty 여유 (kW) | 하이브리드 운전 가능 | 기본 duty 충족 |
| --- | --- | --- | --- | --- | --- | --- |
| 5.0 | 135.0 | 290.2 | 4,244.2 | -3,037.1 | 예 | 아니오 |
| 10.0 | 145.9 | 580.4 | 3,954.0 | -3,037.1 | 예 | 아니오 |
| 15.0 | 156.7 | 870.7 | 3,663.8 | -3,037.1 | 예 | 아니오 |
| 20.0 | 167.5 | 1,160.9 | 3,373.6 | -3,037.1 | 예 | 아니오 |
| 25.0 | 178.3 | 1,451.1 | 3,083.4 | -3,037.1 | 예 | 아니오 |
| 30.0 | 189.1 | 1,741.3 | 2,793.2 | -3,037.1 | 예 | 아니오 |
| 35.0 | 199.9 | 2,031.5 | 2,502.9 | -3,037.1 | 예 | 아니오 |
| 50.0 | 199.9 | 2,031.5 | 2,502.9 | -3,037.1 | 예 | 아니오 |

![거리 민감도](../output/figures/pipeline_distance_sensitivity.png)

거리 증가에 따라 열유입이 거의 선형적으로 증가하면서, 현재 운전점에서의 추정 최대 편도 하이브리드 운전 가능거리는 **103.8 km**로 나타났다. 따라서 **35 km** 조건은 기본안의 단순 확장만으로는 **하이브리드 운전 가능, 기본 LNG duty 불성립 판정**을 받는다.

### 4.5 공급온도 민감도와 35 km 해석

| 공급온도 (°C) | 선정 유체 | Core system power (kW) | 최대 하이브리드 운전 가능거리 (km) | 최대 기본 duty 성립거리 (km) | 35 km 기본 duty 충족 | 상태 |
| --- | --- | --- | --- | --- | --- | --- |
| -63.1 | R-717 (Ammonia) | 137.4 | 83.2 | 0.0 | 아니오 | 성립 |
| -58.1 | R-717 (Ammonia) | 140.9 | 92.5 | 0.0 | 아니오 | 성립 |
| -53.1 | R-717 (Ammonia) | 145.9 | 103.8 | 0.0 | 아니오 | 성립 |
| -48.1 | R-717 (Ammonia) | 152.9 | 117.5 | 0.0 | 아니오 | 성립 |
| -43.1 | R-717 (Ammonia) | 163.4 | 134.4 | 0.0 | 아니오 | 성립 |
| -38.1 | R-717 (Ammonia) | 179.6 | 155.9 | 0.0 | 아니오 | 성립 |
| -33.1 | R-717 (Ammonia) | 206.3 | 183.8 | 0.0 | 아니오 | 성립 |

![공급온도 민감도](../output/figures/supply_temperature_sensitivity.png)

공급온도 스윕 결과, 펌프동력 최소점은 **-63.1 °C**이며 이때도 기본 유체는 **R-717 (Ammonia)**로 유지된다. 공급온도 스윕 범위 안에서는 35 km 기본 LNG duty 조건을 만족하는 운전점이 발견되지 않았다.
...
현재 탐색 범위에서 가장 이른 무보조 warm-up 성립점은 **-63.1 °C / R-717 (Ammonia)** 조합이며, ambient heat gain만으로 LNG hot-end를 만족시키려면 최소 **62.7 km**의 편도 거리가 필요했다. 이때의 루프 펌프동력은 **137.4 kW**였다.
...
다만 공격적 passive heat 탐색에서 형식적으로 warm-up-free 점이 몇 개 나타나더라도, 최소 단열 두께 50 mm와 passive heat 의존도 25% 이하라는 현실성 필터를 적용하면 현재는 **실무적으로 남는 무보조 해가 없었다**. 즉 무보조 성립은 가능성의 증거이지, 바로 채택 가능한 설계의 증거는 아니다.
...
| LNG 시스템 전력사용 | 1,277.7 | MWh/년 |
| 전력 절감 | 35,386.6 | MWh/년 |
| 전력요금 절감 | 3,717.4 | 백만원/년 |
| 회피 간접배출 | 16,224.7 | tCO2/년 |
...
현재 비교 경계에서 LNG 시스템은 연간 **35,386.6 MWh/년**의 전력을 줄이고, 연간 **3,717.4 백만원/년**의 전기요금을 절감하며, 연간 **16,224.7 tCO2/년**의 간접배출을 회피한다.

보조 열원이 완전히 사라지지 않는다면, 전력 기준 최선 시나리오는 **Waste-heat recovery loop**였고 총 시스템 동력은 **195.4 kW**였다. 반면 재무 기준 최선 시나리오는 **Ambient-air trim heater**였으며, 총 설치비 **67.35 십억원**, NPV **-44.93 십억원**으로 정리되었다.
...
| --- | --- | --- | --- | --- | --- | --- |
| Propane | 실패 | - | - | - | - | 아니오 |
| configured_mixture | 실패 | - | - | - | - | 아니오 |
| Methane | 성립 | 494.7 | 0.00 | 8.0 | 47.5 | 예 |
| Ethane | 성립 | 949.1 | 91.87 | 1.7 | 32.6 | 아니오 |

기준 transport proxy는 **Methane**였고, 비교 가능한 proxy들 사이에서 요구 면적 변화는 **0.00% ~ 91.87%**, tube-side 압력강하 변화는 **-78.88% ~ 0.00%** 범위였다. 즉 현재 혼합 LNG 모델은 엔탈피는 일관되게 반영하되, transport proxy 선택이 기화기 상세 제원에는 유의미한 범위를 만든다.
...
| --- | --- | --- | --- | --- | --- |
| Compact equivalent network | 4 | 1.10 | 134.7 | 115.8 | -6.36 |
| Baseline equivalent network | 4 | 1.40 | 143.8 | 123.7 | 0.00 |
| Redundant multi-circuit network | 6 | 1.30 | 153.4 | 131.9 | 6.64 |
| Conservative header-rich network | 4 | 1.75 | 180.0 | 154.8 | 25.16 |

IDC 2차 루프를 등가 단일망으로 보지 않고 회로 수와 분배 길이 계수를 흔들어 보면, 펌프동력은 **115.8 ~ 154.8 kW** 범위로 움직였다. 기본 등가망 시나리오(**Baseline equivalent network**) 대비 가장 보수적인 시나리오 **Conservative header-rich network**의 증가는 **25.16%**였다.
...
둘째, 이번 프로젝트의 진짜 설계 통찰은 35 km 조건의 판정이 운전점과 열수지 가정에 따라 달라질 만큼 민감하다는 사실이다. 이번 결과는 현재 기본안의 경계가 약 **103.8 km**라는 점을 정량적으로 보여준다. 특히 **35 km** 조건은 유압과 액상 유지 관점에서는 아직 해가 존재하지만, 기본 LNG duty만으로는 IDC 부하와 hot-end 요구를 동시에 닫지 못해 supplemental warm-up이 필요하다.

셋째, 이번 모델에서 35 km는 '완전 불성립'이 아니라 하이브리드 운전에서는 성립하지만 기본 LNG duty 경계에서는 불성립하는 조건이다. 따라서 장거리 확장성은 존재하지만, 그 의미를 순수 LNG 냉열 단독 성립으로 읽어서는 안 된다.
...
다섯째, 혼합 LNG와 IDC 2차 루프를 포함하면 설계의 물리적 설명력은 높아지지만, 동시에 외부 장거리 배관 CAPEX가 매우 크게 드러난다. 즉 에너지 측면의 장점과 인프라 투자 부담을 분리해서 읽어야 한다.

보조 열원이 완전히 사라지지 않는다면, 전력 기준 최선 시나리오는 **Waste-heat recovery loop**였고 총 시스템 동력은 **195.4 kW**였다. 반면 재무 기준 최선 시나리오는 **Ambient-air trim heater**였으며, 총 설치비 **67.35 십억원**, NPV **-44.93 십억원**으로 정리되었다.

여섯째, 혼합 LNG surrogate는 이제 엔탈피뿐 아니라 transport proxy 민감도까지 함께 제시할 수 있게 되었다. 따라서 메탄 proxy 하나에만 결과를 걸지 않고, 기화기 면적과 압력강하가 어느 정도 범위에서 흔들리는지 설명할 수 있다.

일곱째, IDC 2차 루프는 현재 등가 배관망 근사이지만, granularity sensitivity를 추가하면서 적어도 pump power가 약 **39.0 kW** 폭 안에서 어떻게 움직이는지 보일 수 있게 되었다. 즉 현재 수치는 단일 숫자가 아니라 네트워크 표현 수준에 따른 범위를 가진다는 점을 명시하게 되었다.
...
본 연구는 총 **13,476.0 kW**의 IDC 냉방부하를 대상으로, LNG 냉열 기반 냉각 시스템이 10 km 기본 설계점에서 **supplemental warm-up을 포함한 하이브리드 운전 기준으로 성립함을 보였다**. 선정된 기본안은 **R-717 (Ammonia)**를 2차 루프 유체로 사용하고, 기화기 duty **18,010.5 kW**, core system power **145.9 kW**, 배관 열유입 **580.4 kW**의 수준에서 IDC 부하를 충족한다. 현재 하이브리드 운전 가능 경계는 약 **103.8 km**이며, 35 km 조건은 **하이브리드 운전 가능, 기본 LNG duty 불성립 판정**으로 정리되었다.
...
| SRC-019 | AFDC LNG Resource Guide | Official PDF | Peak-shaving LNG 평균 조성: CH4 95.3%, C2H6 4.1%, C3H8 0.43%, C4H10 0.08%, N2 0.02%; LNG는 정제 후 mostly methane 85-99% |
| SRC-020 | CoolProp Mixtures documentation | Official web | HEOS mixture string 형식과 mixture flash 지원 범위 |
| SRC-021 | NETL Process Equipment Cost Estimation Final Report | Official PDF | Shell-and-tube heat exchanger installed cost table; centrifugal pump installed cost table; 1Q 1998 USD basis |
| SRC-022 | BLS historical CPI-U table | Official PDF | 1998 annual average CPI-U = 163.0 |
| SRC-023 | FRED CPIAUCSL monthly CPI series | Official data portal | 2026-02 CPI-U all-items index = 326.785 used as current-price escalation anchor |
| SRC-024 | FRED South Korean won to U.S. dollar spot exchange rate | Official data portal | 2026-02 monthly average KRW/USD = 1447.2858 |
| SRC-025 | DOE H2A hydrogen delivery interim report | Official PDF | Urban steel distribution pipeline cost trend lines and unit-cost tables in USD/mile |
