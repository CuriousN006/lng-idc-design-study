...
- 추정 최대 하이브리드 편도 성립거리는 약 103.8 km다.
- 기본 LNG duty 기준 최대 편도 성립거리는 약 0.0 km다.
- 따라서 현재 설계점에서 35 km 조건은 하이브리드 성립, 기본 LNG duty 불성립이라고 정리한다.
...
- 동시에 35 km 조건은 현재 기본안에서 하이브리드 성립, 기본 LNG duty 불성립이며, 추정 최대 하이브리드 편도 성립거리는 약 103.8 km라고 정리한다.
